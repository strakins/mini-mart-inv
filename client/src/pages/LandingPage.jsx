          ...
          <div className="flex justify-between h-16 items-center">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <h1 className="text-md sm:text-2xl font-bold text-indigo-600">StoreInventory</h1>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 flex-1">
        <div className="text-center">
          <h1 className="text-2xl sm:text-4xl md:text-6xl font-bold text-gray-900 mb-4 sm:mb-6">
            ...
            <span className="text-indigo-600 block mt-2">With Strakins Inventory Management App</span>
          </h1>
